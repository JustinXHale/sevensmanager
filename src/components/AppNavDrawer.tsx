...
const IconCanvas = () => (
  <svg viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" width={18} height={18}>
    <path
      fillRule="evenodd"
      d="M3 4.75A2.75 2.75 0 0 1 5.75 2h8.5A2.75 2.75 0 0 1 17 4.75v10.5A2.75 2.75 0 0 1 14.25 18H5.75A2.75 2.75 0 0 1 3 15.25V4.75ZM5.75 3.5c-.69 0-1.25.56-1.25 1.25v10.5c0 .69.56 1.25 1.25 1.25h8.5c.69 0 1.25-.56 1.25-1.25V4.75c0-.69-.56-1.25-1.25-1.25h-8.5Zm1.5 2.5a.75.75 0 0 0 0 1.5h6a.75.75 0 0 0 0-1.5h-6Zm0 3.5a.75.75 0 0 0 0 1.5h6a.75.75 0 0 0 0-1.5h-6Zm0 3.5a.75.75 0 0 0 0 1.5h3.5a.75.75 0 0 0 0-1.5h-3.5Z"
      clipRule="evenodd"
    />
  </svg>
);
    ...
    <>
      ...
      >
        <nav id={panelId} className={`app-nav-drawer${open ? ' app-nav-drawer-open' : ''}`} aria-hidden={false}>
          ...
          <ul className="app-nav-drawer-list">
            <li>
              <Link to="/plays" className="app-nav-drawer-link" onClick={close}>
                <IconCanvas /> Canvas
              </Link>
            </li>
            <li>
