...
### Changed
- Match **Roster** tab: drag-and-drop board with On field / Bench / Off zones; ↑↓ reorder and drop-on-row positioning for custom on-field order (e.g. 8, 2, 5, 7), persisted to match session for live tracking
